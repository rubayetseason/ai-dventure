...
const formSchema = z.object({
  from: z.string({ required_error: "Location is required" }),
  to: z.string({ required_error: "Location is required" }),
  date: z
    .object({
  ...
  travellers: z
    .number({ required_error: "Traveller count is required" })
...
const Searchbox = () => {
  ...
  return (
    <div className="w-full font-raleway flex flex-col items-center justify-center min-h-screen px-4 z-10">
      ...
      <div className="max-w-screen-lg mx-auto bg-white/40 rounded-lg md:rounded-2xl">
        <Form {...form}>
